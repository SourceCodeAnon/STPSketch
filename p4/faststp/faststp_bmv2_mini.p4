...
control MyIngress(inout headers_t hdr,
    ...
    apply {
        ...
        // 只测量 IPv4；但非 IPv4 不要 drop，直接 return（此时已设置好 egress_spec）
...
// p4c --std p4-16 --target bmv2 --arch v1model -o ~/stpsketch/behavioral-model/build ~/stpsketch/faststp/faststp_bmv2_mini.p4